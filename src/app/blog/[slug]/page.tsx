...
function ResellingProfitMistakes() {
  return (
    <article className="prose prose-zinc max-w-none">
      <p className="text-zinc-600 lead">
      ...
      <h2 className="text-zinc-900">1. Tracking revenue instead of profit</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">2. Not knowing the real cost of a haul</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">3. Ignoring business expenses entirely</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">4. Assuming your biggest platform is your best platform</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">5. Reconstructing records at tax time</h2>
      <p className="text-zinc-600">
      ...
      <h2 className="text-zinc-900">The common thread</h2>
      <p className="text-zinc-600">
...
function HowToTrackResellingProfits() {
  return (
    <article className="prose prose-zinc max-w-none">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">Why most resellers don't know their real profit</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">The four numbers you actually need to track</h2>
      <p className="text-zinc-600">
        Every sale has four components that determine your real profit:
      </p>
      <ul className="text-zinc-600 space-y-2">
        <li><span className="text-zinc-900 font-medium">Sale price</span> — what the buyer paid</li>
        <li><span className="text-zinc-900 font-medium">Platform fee</span> — what the platform takes (<Link href="/calculators/ebay" className="text-emerald-600 hover:text-emerald-700">eBay ~13.25%</Link>, <Link href="/calculators/poshmark" className="text-emerald-600 hover:text-emerald-700">Poshmark 20%</Link>, <Link href="/calculators/mercari" className="text-emerald-600 hover:text-emerald-700">Mercari 10%</Link>, etc.)</li>
        <li><span className="text-zinc-900 font-medium">Cost of goods (COGS)</span> — what you paid for the item</li>
        <li><span className="text-zinc-900 font-medium">Shipping cost</span> — what you actually paid to ship it, not what you charged</li>
      </ul>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">When to record each number</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">Tracking across multiple platforms</h2>
      <p className="text-zinc-600">
        Selling on <Link href="/calculators/ebay" className="text-emerald-600 hover:text-emerald-700">eBay</Link> and <Link href="/calculators/poshmark" className="text-emerald-600 hover:text-emerald-700">Poshmark</Link> simultaneously is where spreadsheets start breaking down. You end up with separate tabs, inconsistent column names, and no single view of how your business is actually doing.
      </p>
      <p className="text-zinc-600">
      ...
      <p className="text-zinc-600">
        This also matters when you're deciding which platform to use for a given item. If you track properly, you can see over time that Mercari outperforms eBay on certain categories for you — or that Facebook Marketplace has better margins despite lower prices. That's data you can't get from a gut feeling. You can also <Link href="/calculators/compare" className="text-emerald-600 hover:text-emerald-700">compare platform fees side by side</Link> before you list.
      </p>

      <div className="mt-8" />
      <h2 className="text-zinc-900">Handling hauls and bulk purchases</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">Business expenses beyond the items</h2>
      <p className="text-zinc-600">
      ...
      <div className="mt-8" />
      <h2 className="text-zinc-900">Choosing a system that sticks</h2>
      <p className="text-zinc-600">
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <Link href="/blog" className="text-xs text-zinc-500 hover:text-zinc-700 transition-colors mb-8 inline-block">← Blog</Link>
      ...
      <footer className="border-t border-zinc-200 mt-16">
        <div className="max-w-5xl mx-auto px-6 py-6 flex flex-wrap items-center justify-between gap-4">
          <p className="text-xs text-zinc-500">© {new Date().getFullYear()} MarginLog</p>
