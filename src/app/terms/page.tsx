    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-zinc-600 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">4. Acceptable use</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">5. Billing and subscriptions</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">6. Data and exports</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">7. Service availability</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">8. Fee accuracy</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">9. Limitation of liability</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">10. Termination</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">11. Changes to terms</h2>
          ...
          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">12. Governing law</h2>
            <p>These terms are governed by the laws of Canada. Any disputes will be resolved in Canadian courts.</p>
          </section>

          <section>
            <h2 className="text-zinc-900 font-semibold mb-2">13. Contact</h2>
            <p>Questions about these terms: <a href="mailto:ahmedsaqib998@gmail.com" className="text-emerald-600 hover:text-emerald-700">ahmedsaqib998@gmail.com</a></p>
          </section>
        </div>
      </main>
