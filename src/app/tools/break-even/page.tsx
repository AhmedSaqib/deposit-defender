    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-8">
          <p className="text-xs text-zinc-500 mb-3">
            <Link href="/tools" className="hover:text-zinc-600">Tools</Link> / Break-Even Calculator
          </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/tools/profit-benchmark" className="text-sm text-zinc-600 hover:text-zinc-900 border border-zinc-300 hover:border-zinc-400 px-4 py-2 rounded-lg transition-colors">
            Profit margin benchmarks →
          </Link>
        </div>

        <div className="mt-10 bg-white border border-zinc-200 rounded-2xl p-6 text-center">
          <p className="text-sm font-medium text-zinc-900 mb-1">Log every sale and track your real profit automatically</p>
          <p className="text-sm text-zinc-600 mb-5">MarginLog deducts platform fees on every sale. Dashboard, analytics, and CSV export for tax season — free to start.</p>
      ...
      <footer className="border-t border-zinc-200 mt-16">
        <div className="max-w-5xl mx-auto px-6 py-6 flex flex-wrap gap-4 text-xs text-zinc-500">
          ...
          <Link href="/glossary/break-even" className="hover:text-zinc-600 transition-colors">What is break-even?</Link>
        </div>
      </footer>
    </div>
  )
