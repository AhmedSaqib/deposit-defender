...
export const metadata: Metadata = {
  ...
  description: "RentProof.ai privacy policy — what data we collect, how it is used, and your rights.",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-10 space-y-10 text-sm text-gray-700 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            RentProof (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) is an independent software product operated by a software
            developer based in Kitchener, Ontario, Canada. You can contact us at{" "}
            <a href="mailto:hello@rentproof.ai" className="text-blue-700 hover:underline">hello@rentproof.ai</a>.
          </p>
          <p>
            This policy explains what information we collect, how we use it, and what rights you have over it. It
            applies to all visitors and users of rentproof.ai and its subpages.
          </p>
        </section>
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-2">
              ...
              <p>
                ...
                <strong>not written to any database or file storage by RentProof</strong>.
              </p>
              <p>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-2">
              ...
              <p>
                ...
                addresses, dispute details) is ever transmitted to RentProof servers or any third party. It does
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-2">
              ...
              <p>
                RentProof is hosted on Vercel. Vercel automatically collects standard server log data, including
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-2">
              ...
              <p>
                RentProof does not set any tracking or advertising cookies. Vercel may set a minimal session
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <p>RentProof relies on two third-party infrastructure providers:</p>
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <p>
            Because RentProof does not store your submitted content, most erasure or access requests relate to
          ...
          <p>
            To exercise any privacy rights with RentProof, contact us at{" "}
            <a href="mailto:hello@rentproof.ai" className="text-blue-700 hover:underline">hello@rentproof.ai</a>.
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <p>
            All data in transit between your browser, RentProof servers, and Anthropic is encrypted using TLS
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <p>
            RentProof is not directed at children under the age of 16. We do not knowingly collect personal
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <p>
            ...
            RentProof after changes are posted constitutes acceptance of the updated policy.
          </p>
        </section>
        ...
        <section className="space-y-3 border-t border-gray-100 pt-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-sm space-y-1">
            <p className="font-semibold text-gray-900">RentProof</p>
            <p className="text-gray-600">Kitchener, Ontario, Canada</p>
            <a href="mailto:hello@rentproof.ai" className="text-blue-700 hover:underline font-medium">hello@rentproof.ai</a>
          </div>
        </section>
